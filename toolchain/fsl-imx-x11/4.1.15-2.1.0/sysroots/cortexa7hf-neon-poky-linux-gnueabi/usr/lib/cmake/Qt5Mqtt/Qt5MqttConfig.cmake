...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Mqtt" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Mqtt_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.9"
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.9/QtMqtt"
    )
    ...
    macro(_populate_Mqtt_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Mqtt_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Mqtt_check_file_exists(${imported_location})

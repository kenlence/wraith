...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.12.9"
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.12.9/QtMultimediaWidgets"
    )
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "libQt5MultimediaWidgets.so.5.12.9" "" )
    ...
    macro(_populate_MultimediaWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5MultimediaWidgets_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_MultimediaWidgets_check_file_exists(${imported_location})

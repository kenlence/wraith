...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.12.9"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.12.9/QtNetwork"
    )
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.12.9" "" )
    ...
    macro(_populate_Network_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Network_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Network_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5PublishSubscribe" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5PublishSubscribe_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::PublishSubscribe)
    ...
    macro(_populate_PublishSubscribe_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PublishSubscribe_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_PublishSubscribe_check_file_exists(${imported_location})

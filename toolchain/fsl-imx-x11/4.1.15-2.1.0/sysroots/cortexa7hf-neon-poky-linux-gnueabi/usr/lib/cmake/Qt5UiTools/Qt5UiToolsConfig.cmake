...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5UiTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5UiTools_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5UiTools_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.12.9"
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.12.9/QtUiTools"
    )
    ...
    foreach(_module_dep ${_Qt5UiTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5UiTools_FIND_VERSION_EXACT}
    ...
    macro(_populate_UiTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiTools_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_UiTools_check_file_exists(${imported_location})

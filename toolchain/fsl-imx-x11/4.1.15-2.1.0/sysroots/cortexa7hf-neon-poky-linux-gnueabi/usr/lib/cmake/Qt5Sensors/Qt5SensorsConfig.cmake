...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.12.9"
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.12.9/QtSensors"
    )
    ...
    _populate_Sensors_target_properties(RELEASE "libQt5Sensors.so.5.12.9" "" )
    ...
    macro(_populate_Sensors_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Sensors_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Help" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Help_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/QtHelp/5.12.9"
        "${_qt5Help_install_prefix}/include/QtHelp/5.12.9/QtHelp"
    )
    ...
    _populate_Help_target_properties(RELEASE "libQt5Help.so.5.12.9" "" )
    ...
    macro(_populate_Help_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Help_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Help_check_file_exists(${imported_location})

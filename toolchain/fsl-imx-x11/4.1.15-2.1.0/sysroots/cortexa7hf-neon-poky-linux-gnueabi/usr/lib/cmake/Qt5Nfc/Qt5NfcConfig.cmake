...
if (NOT TARGET Qt5::Nfc)
    ...
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/include/QtNfc/5.12.9"
        "${_qt5Nfc_install_prefix}/include/QtNfc/5.12.9/QtNfc"
    )
    ...
    _populate_Nfc_target_properties(RELEASE "libQt5Nfc.so.5.12.9" "" )
    ...
    macro(_populate_Nfc_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Nfc_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Nfc_check_file_exists(${imported_location})

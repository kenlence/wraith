...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5X11Extras" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5X11Extras_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5X11Extras_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::X11Extras)
    ...
    foreach(_module_dep ${_Qt5X11Extras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5X11Extras_FIND_VERSION_EXACT}
    ...
    _populate_X11Extras_target_properties(RELEASE "libQt5X11Extras.so.5.12.9" "" )
    ...
    macro(_populate_X11Extras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5X11Extras_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_X11Extras_check_file_exists(${imported_location})

...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/QtScript/5.12.9"
        "${_qt5Script_install_prefix}/include/QtScript/5.12.9/QtScript"
    )
    ...
    _populate_Script_target_properties(RELEASE "libQt5Script.so.5.12.9" "" )
    ...
    macro(_populate_Script_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Script_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Script_check_file_exists(${imported_location})

...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    set(Qt53DQuickExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickExtras_install_prefix}/include/Qt3DQuickExtras/5.12.9"
        "${_qt53DQuickExtras_install_prefix}/include/Qt3DQuickExtras/5.12.9/Qt3DQuickExtras"
    )
    ...
    _populate_3DQuickExtras_target_properties(RELEASE "libQt53DQuickExtras.so.5.12.9" "" )
    ...
    macro(_populate_3DQuickExtras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DQuickExtras_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickExtras_check_file_exists(${imported_location})

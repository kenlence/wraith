...
set(Qt5Enginio_VERSION_STRING 1.8.0)
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.8.0"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.8.0/Enginio"
    )
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.8.0 ${_Qt5Enginio_FIND_VERSION_EXACT}
    ...
    _populate_Enginio_target_properties(RELEASE "libEnginio.so.1.8.0" "" )
    ...
    macro(_populate_Enginio_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Enginio_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Enginio_check_file_exists(${imported_location})

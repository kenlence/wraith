...
get_filename_component(_realOrig "/usr/lib/cmake/Qt53DExtras" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt53DExtras_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.12.9"
        "${_qt53DExtras_install_prefix}/include/Qt3DExtras/5.12.9/Qt3DExtras"
    )
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.so.5.12.9" "" )
    ...
    macro(_populate_3DExtras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DExtras_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_3DExtras_check_file_exists(${imported_location})

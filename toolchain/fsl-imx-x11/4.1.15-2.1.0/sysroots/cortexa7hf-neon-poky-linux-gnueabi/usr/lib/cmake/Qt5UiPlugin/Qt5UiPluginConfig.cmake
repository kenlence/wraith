...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5UiPlugin" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5UiPlugin_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::UiPlugin)
    ...
    foreach(_module_dep ${_Qt5UiPlugin_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5UiPlugin_FIND_VERSION_EXACT}
    ...
    macro(_populate_UiPlugin_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiPlugin_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")

...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5VirtualKeyboard" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5VirtualKeyboard_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.9"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.9/QtVirtualKeyboard"
    )
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.so.5.12.9" "" )
    ...
    macro(_populate_VirtualKeyboard_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5VirtualKeyboard_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_VirtualKeyboard_check_file_exists(${imported_location})

...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.12.9"
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.12.9/QtScriptTools"
    )
    ...
    _populate_ScriptTools_target_properties(RELEASE "libQt5ScriptTools.so.5.12.9" "" )
    ...
    macro(_populate_ScriptTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5ScriptTools_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_ScriptTools_check_file_exists(${imported_location})

...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/QtSvg/5.12.9"
        "${_qt5Svg_install_prefix}/include/QtSvg/5.12.9/QtSvg"
    )
    ...
    _populate_Svg_target_properties(RELEASE "libQt5Svg.so.5.12.9" "" )
    ...
    macro(_populate_Svg_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Svg_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Svg_check_file_exists(${imported_location})

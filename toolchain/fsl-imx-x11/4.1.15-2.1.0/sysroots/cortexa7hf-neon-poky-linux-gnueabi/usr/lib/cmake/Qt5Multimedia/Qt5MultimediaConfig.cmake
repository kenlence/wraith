...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.12.9"
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.12.9/QtMultimedia"
    )
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.12.9" "" )
    ...
    macro(_populate_Multimedia_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Multimedia_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Multimedia_check_file_exists(${imported_location})

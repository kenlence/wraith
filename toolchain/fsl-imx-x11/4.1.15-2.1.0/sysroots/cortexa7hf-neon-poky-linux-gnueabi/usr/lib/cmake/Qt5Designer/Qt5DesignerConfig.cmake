...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Designer" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Designer_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.12.9"
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.12.9/QtDesigner"
    )
    ...
    _populate_Designer_target_properties(RELEASE "libQt5Designer.so.5.12.9" "" )
    ...
    macro(_populate_Designer_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Designer_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Designer_check_file_exists(${imported_location})

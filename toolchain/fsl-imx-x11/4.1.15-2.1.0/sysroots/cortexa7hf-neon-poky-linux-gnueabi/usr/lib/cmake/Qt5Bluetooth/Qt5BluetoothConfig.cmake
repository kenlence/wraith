...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.12.9"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.12.9/QtBluetooth"
    )
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.so.5.12.9" "" )
    ...
    macro(_populate_Bluetooth_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Bluetooth_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Bluetooth_check_file_exists(${imported_location})

...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Charts" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Charts_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Charts)
    ...
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/QtCharts/5.12.9"
        "${_qt5Charts_install_prefix}/include/QtCharts/5.12.9/QtCharts"
    )
    ...
    _populate_Charts_target_properties(RELEASE "libQt5Charts.so.5.12.9" "" )
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Charts_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})

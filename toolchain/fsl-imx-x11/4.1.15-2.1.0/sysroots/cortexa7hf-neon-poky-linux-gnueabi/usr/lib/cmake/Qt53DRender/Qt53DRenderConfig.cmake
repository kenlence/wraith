...
get_filename_component(_realOrig "/usr/lib/cmake/Qt53DRender" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt53DRender_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.12.9"
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.12.9/Qt3DRender"
    )
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so.5.12.9" "" )
    ...
    macro(_populate_3DRender_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DRender_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_3DRender_check_file_exists(${imported_location})

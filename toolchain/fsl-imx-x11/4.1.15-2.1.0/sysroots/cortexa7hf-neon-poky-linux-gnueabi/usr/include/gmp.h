...
#define __GMP_CC "arm-poky-linux-gnueabi-gcc  -march=armv7ve -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a7 "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer  -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/work/cortexa7hf-neon-poky-linux-gnueabi/gmp/6.1.0-r0=/usr/src/debug/gmp/6.1.0-r0 -fdebug-prefix-map=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/sysroots/imx6ull14x14evk= "

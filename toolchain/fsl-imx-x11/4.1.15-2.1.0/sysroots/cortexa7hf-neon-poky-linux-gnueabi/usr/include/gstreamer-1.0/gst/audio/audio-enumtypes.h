...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-format.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-channels.h" */
GType gst_audio_channel_position_get_type (void);
#define GST_TYPE_AUDIO_CHANNEL_POSITION (gst_audio_channel_position_get_type())

/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-channel-mixer.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-converter.h" */
GType gst_audio_converter_flags_get_type (void);
#define GST_TYPE_AUDIO_CONVERTER_FLAGS (gst_audio_converter_flags_get_type())

/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-info.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/audio-quantize.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/audio/gstaudioringbuffer.h" */

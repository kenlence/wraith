...
/* enumerations from "../../gstreamer-1.8.1/gst/gstbufferpool.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstbus.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstcaps.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstclock.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gsterror.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstevent.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstformat.h" */
GType gst_format_get_type (void);
#define GST_TYPE_FORMAT (gst_format_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gstinfo.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstiterator.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstmessage.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstmeta.h" */
GType gst_meta_flags_get_type (void);
#define GST_TYPE_META_FLAGS (gst_meta_flags_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gstmemory.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstminiobject.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstpad.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstpadtemplate.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstpipeline.h" */
GType gst_pipeline_flags_get_type (void);
#define GST_TYPE_PIPELINE_FLAGS (gst_pipeline_flags_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gstplugin.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstpluginfeature.h" */
GType gst_rank_get_type (void);
#define GST_TYPE_RANK (gst_rank_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gstquery.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstsegment.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstsystemclock.h" */
GType gst_clock_type_get_type (void);
#define GST_TYPE_CLOCK_TYPE (gst_clock_type_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gsttaglist.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gsttask.h" */
GType gst_task_state_get_type (void);
#define GST_TYPE_TASK_STATE (gst_task_state_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gsttoc.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gsttracerrecord.h" */
...
/* enumerations from "../../gstreamer-1.8.1/gst/gstutils.h" */
GType gst_search_mode_get_type (void);
#define GST_TYPE_SEARCH_MODE (gst_search_mode_get_type())

/* enumerations from "../../gstreamer-1.8.1/gst/gstparse.h" */

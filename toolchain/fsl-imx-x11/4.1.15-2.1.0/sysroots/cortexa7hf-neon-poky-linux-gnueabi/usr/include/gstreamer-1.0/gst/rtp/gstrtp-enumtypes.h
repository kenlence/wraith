...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/rtp/gstrtpdefs.h" */
GType gst_rtp_profile_get_type (void);
#define GST_TYPE_RTP_PROFILE (gst_rtp_profile_get_type())

/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/rtp/gstrtpbuffer.h" */
GType gst_rtp_buffer_map_flags_get_type (void);
#define GST_TYPE_RTP_BUFFER_MAP_FLAGS (gst_rtp_buffer_map_flags_get_type())

/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/rtp/gstrtcpbuffer.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/rtp/gstrtppayloads.h" */

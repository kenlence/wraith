...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/pbutils/install-plugins.h" */
GType gst_install_plugins_return_get_type (void);
#define GST_TYPE_INSTALL_PLUGINS_RETURN (gst_install_plugins_return_get_type())

/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/pbutils/gstdiscoverer.h" */
...
/* enumerations from "../../../../gst-plugins-base-1.8.1/gst-libs/gst/pbutils/gstaudiovisualizer.h" */
